...
# 输入启动脚本
echo "sudo docker run -d --name onebot-docker0 -p 3000:3000 -p 6099:6099 -p 3001:3001 -p 5500:5500 -v ${PWD}/LiteLoader:/opt/QQ/resources/app/LiteLoader garrise/ll-cc-docker" > start.sh
